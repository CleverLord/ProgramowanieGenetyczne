...
condition: expression comparator expression ; // thing comp thing //this must be evalueable to boolean
assignment: variable '=' expression ';' ; // x_1 = (2+(3*4))
expression: constant | variable | nestedExp | read ; // this must evaluate to value
nestedExp: '(' expression operator expression ')' ; // this also must evaluate to value
