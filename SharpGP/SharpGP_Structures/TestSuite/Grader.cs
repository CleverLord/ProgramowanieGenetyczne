...
public class Grader
{
    ...
    public double accuracyScore(TestCase tc, ProgramRunContext prc)
    {
    ...
    public double hasTargetValue(TestCase tc, ProgramRunContext prc)
    {
        List<double> output = prc.GetOutput();
    ...
    public bool hasTargetValue(double target, List<double> output)
    {
