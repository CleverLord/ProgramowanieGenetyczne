...
public abstract class Node
{
    ...
    protected int indend;
    protected Node parent;

    protected void UpdateIndent()
    {
        children?.ForEach(n => n.indend = indend + 1);
    }
    ...
    {
        var newnode =
            (Node)MemberwiseClone(); // shallow copy of indent and Inheritance stuff (like value of the Constant, name of the Variable, etc.)
    ...
    public static void CrossNodes(Node n1, Node n2)
    {
        ...
        var i1 = p1.children.IndexOf(n1);
        var i2 = p2.children.IndexOf(n2);
        //swap children
        p1.children[i1] = n2;
        p2.children[i2] = n1;
        //fix parents
